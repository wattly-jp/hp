...
> **メタディスクリプション**: 2022年に30社以上が撤退した新電力。共通点は「安さ」を売りにしていたこと。安い理由を知らずに選ぶリスクと、安さが壊れにくい電力会社の見分け方。
> **スラッグ**: cheap-power-company-fragility
> **クラスター**: 5（電力の基礎知識）
> **ターゲット**: 電力会社の乗り換えを検討中の人、「安い順」で選ぼうとしている人
> **タグ**: #新電力 #電力自由化 #撤退 #電力会社選び #基礎知識
> **内部リンク先**: `electricity-bill-structure` / `power-liberalization-guide` / `electricity-liberalization-10years` / `best-power-company-single`
...
確認方法はシンプルで、会社のWebサイトに「電源構成」「発電所一覧」のページがあるか。なければ、市場から100%仕入れている可能性が高い。
