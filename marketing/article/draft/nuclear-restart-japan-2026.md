...
「地域差があるのは知ってるけど、そこまで違うの？」——そう思ったなら、この記事はそのまま使えます。
...
**使用量の削減**。電源構成は変えられなくても、使う量は減らせます。[電気代を下げるための具体的な選択肢](/column/save-electricity-tips)を知っておくだけで、月数百円〜数千円の差が出る。特にエアコンの設定温度と待機電力の見直しは、手間の割に効果が大きい。
