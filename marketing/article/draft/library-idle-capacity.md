...
> スラッグ: library-idle-capacity
> クラスター: 構造・視座系
> ターゲット: 「無駄」と「冗長性」の区別がつかないまま効率化を求める読者
> 内部リンク: `infrastructure-invisible-support`, `demand-peak-controls-all`, `insurance-uninsurable-risk`
...
電力系統の「予備率」という概念がある。実際の需要に対して、供給能力をどれだけ余分に確保しているかの割合だ。日本では安定供給の目安として予備率3%以上が求められている。3%と聞くと少なく感じるが、これは「常に余らせておく」という設計思想の表れだ。

[電球が切れたとき初めて天井の存在を思い出す](/column/infrastructure-invisible-support)で書いたように、インフラは「使えて当然」の状態を維持するために、見えないところでコストを払い続けている。
...
電力系統もまったく同じ問題を抱えている。[工場の電気代は「使った量」より「一瞬の最大値」で決まる](/column/demand-peak-controls-all)で触れたが、電力のピーク需要は予測と実際が常にズレる。猛暑日にエアコンが一斉に動けば、予測を超えた電力が必要になる。

その「予測を超えた瞬間」に対応するための余力を、平時から持っておく。使われないまま終わる日がほとんどだとしても、必要になった瞬間に存在しなければ取り返しがつかない。

[保険会社が嫌いなリスクが一番大きいリスクだ](/column/insurance-uninsurable-risk)で書いた「規模が読めないリスク」は、まさにこの問題だ。「いつ必要になるかわからない」ものに対して、どこまでコストを払うか。これはリスク管理の本質的な問いであり、図書館の蔵書構成も、電力系統の設計も、同じ問いに答えている。
...
図書館でも同じことが起きている。「利用率が低い蔵書を除籍（廃棄）しよう」という方針を進めた図書館が、数年後に「その本を探している利用者に応えられない」事態に直面している。学術書や専門書は日常的には借りられないが、必要な時にはその図書館にしかない。
...
*電気代の内訳の中にも「使っていないのに払っているコスト」がある。その構造については[電気料金の仕組み解説](/column/electricity-bill-structure)で詳しく解説しています。*
