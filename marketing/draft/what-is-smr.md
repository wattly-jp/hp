...
### 1. AIとデータセンターによる電力需要の急増

IEAの試算では、**世界のデータセンターの電力消費量は2026年に2022年比で約2.2倍**に。24時間安定して大量の電気を供給できる電源が必要——そこでSMRが注目されています。Google、Amazon、MicrosoftがSMR関連企業に投資を進めています。データセンターの電力問題について詳しくは `datacenter-power-demand` で解説しています。

### 2. 脱炭素

原子力は発電時にCO2を排出しません。再エネだけでは脱炭素が難しいという見方が広がり、「再エネ＋原子力」の組み合わせが再評価されています。

### 3. エネルギー安全保障

化石燃料の輸入に頼るリスクは、ホルムズ海峡問題で改めて浮き彫りに。国内で発電が完結する原子力は安全保障の面でも見直されています。
