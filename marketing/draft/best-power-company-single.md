...
**具体例**: 基本料金0円・従量料金30円/kWhのプランと、基本料金572円（20A）・従量料金が三段階制（〜120kWh: 20円）の大手プラン。月100kWhだと前者は3,000円、後者は2,572円。基本料金0円のほうが高くなるケースです。
...
燃料費調整は見落としがちですが、月に数百〜数千円の差になることも。詳しくは `new-power-demerits` で解説しています。
...
比較する際は、最も電気代が高くなる冬のデータも含めて年間で計算するのが正確です。
...
電力会社の乗り換え以外にも、電気代を下げる方法はあります。使い方の工夫（省エネ）については `save-electricity-tips` で詳しく解説しています。
