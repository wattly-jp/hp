...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/providers`, lastModified: new Date("2026-04-03"), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/providers/own-generation`, lastModified: new Date("2026-04-03"), changeFrequency: "monthly", priority: 0.8 },
