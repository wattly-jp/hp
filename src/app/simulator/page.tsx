    ...
    <>
      ...
      <section className="py-14 px-4 bg-wt-surface-alt">
        <div className="mx-auto max-w-3xl prose-wt">
          ...
          <h2>電力会社を選ぶポイント</h2>
          <p>
            電力自由化により、お住まいのエリアで複数の電力会社から選べるようになりました。選ぶ際は料金だけでなく、燃料費調整の仕組み（市場連動型かどうか）、解約金の有無、ガスとのセット割なども確認しましょう。
          </p>
          <p>
            使用量が少ない一人暮らしの場合は大手電力とほとんど差がないケースもあります。一方、ファミリー世帯など使用量が多い場合は、年間で1万円以上の差が出ることもあります。
          </p>
        </div>
      </section>
    </>
